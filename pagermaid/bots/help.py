...
@listener(is_plugin=False, incoming=True, command=alias_command("help"),
...
@listener(is_plugin=False, incoming=True, command=alias_command("help_raw"),
          description=lang('help_des'),
          parameters=f"<{lang('command')}>")
...
@listener(is_plugin=False, incoming=True, owners_only=True, command=alias_command("lang"),
